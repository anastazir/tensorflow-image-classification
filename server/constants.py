...
wildlife_labels=['baldeagle', 'blackbear', 'bobcat', 'canadalynx', 'columbianblack-taileddeer ', 'cougar',
'coyote', 'deer', 'elk', 'graywolf', 'mountainbeaver', 'nutria', 'raven', 'redfoxgrayfox', 'ringtail', 
'sea_lionsraccoon', 'seals', 'virginiaopossum']
